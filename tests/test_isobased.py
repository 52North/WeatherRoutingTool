...
def test_update_position_fail():
    ...
    dist_test = np.array([[dist_travel, dist_travel, dist_travel, dist_travel], [0, 0, 0, 0]])
    az_test = np.array([  # [az_till_start,az_till_start,az_till_start,az_till_start],
        [az, az, az, az], [0, 0, 0, 0]])
...
def test_pruning_select_correct_idxs():
    ...
    full_fuel_test = np.array(
        [full_fuel_consumed[0, 1], full_fuel_consumed[0, 2], full_fuel_consumed[0, 5], full_fuel_consumed[0, 6]])
