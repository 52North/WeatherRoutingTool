...
class SinglePointCrossover(OffspringRejectionCrossover):
    ...
    def crossover(self, p1, p2):
        ...
        p1x = utils.RNG.integers(1, p1.shape[0] - 1)
        p2x = utils.RNG.integers(1, p2.shape[0] - 1)
...
class TwoPointCrossover(OffspringRejectionCrossover):
    ...
    def crossover(self, p1, p2):
        ...
        p1x1 = utils.RNG.integers(1, p1.shape[0] - 4)
        p1x2 = p1x1 + utils.RNG.integers(3, p1.shape[0] - p1x1 - 1)

        p2x1 = utils.RNG.integers(1, p2.shape[0] - 4)
        p2x2 = p2x1 + utils.RNG.integers(3, p2.shape[0] - p2x1 - 1)
...
class RandomizedCrossoversOrchestrator(CrossoverBase):
    ...
    def _do(self, problem, X, **kw):
        opt = self.opts[utils.RNG.integers(0, len(self.opts))]
