...
class ShipParams():
    ...
    def set_default_array_1D(cls, ncoorinate_points):
        return cls(speed=np.full(shape=ncoorinate_points, fill_value=0),
                   ...
                   wave_height=np.full(shape=ncoorinate_points, fill_value=0),
                   wave_direction=np.full(shape=ncoorinate_points, fill_value=0),
                   wave_period=np.full(shape=ncoorinate_points, fill_value=0),
                   u_currents=np.full(shape=ncoorinate_points, fill_value=0),
                   v_currents=np.full(shape=ncoorinate_points, fill_value=0),
                   u_wind_speed=np.full(shape=ncoorinate_points, fill_value=0),
                   v_wind_speed=np.full(shape=ncoorinate_points, fill_value=0),
                   pressure=np.full(shape=ncoorinate_points, fill_value=0),
