...
class Tanker(Boat):
    ...
    def get_fuel_for_fixed_waypoints(self, route_lats, route_lons, start_time, bs):
        ...
        ship_params = self.get_fuel_per_time_netCDF(courses, start_lats, start_lons, start_times)
        return ship_params
